...
function VideoInfo(props){
  ...
  return (<>
    ...
    <div class="video-desc">
      ...
      <p><h>THIS IS NOT THE DESCRIPTION OF SONG</h><br></br> 
      Hii I am Vivaan and
      I'm thrilled to announce the successful completion of my YouTube Clone Project in the WebDev bootcamp by Explorin.<br></br>

This journey introduced me to HTML, CSS, JavaScript, and ReactJS, culminating in a React JS project — an important achievement in my web development endeavors<br></br>.

Thanks to Team Explorin for fantastic coaching and support throughout the bootcamp.<br></br>

Check out my project repo: GitHub_Repo_Link<br></br>

#Explorin #DareToDream <br></br>
<b>more...</b></p>
    </div>
    <div className='Comments'>
      <div><b>564 Comments</b></div>
